        ...
        <div className="section about" id="about">
            <div className="container about-left">
                ...
                <p>
                    ...
                    cumque quam modi provident dicta facere soluta ab molestias eaque, alias sequi.
                    Aliquid nostrum ut sit repudiandae incidunt, a tenetur? Lorem, ipsum dolor sit
                    amet consectetur adipisicing elit. Deleniti
                </p>

                <a href="https://t.ly/a3N6W" className="link" target="_blank">
                    <p>
                        SE VIDEON <img src="/images/about/play-button.svg" alt="" />
                    </p>
                </a>
            </div>
